        ...
        <div className={styles.fetch_selector_container}>
          ...
          <div className={styles.select_container}>
            ...
            >
              ...
              <option value={"wallet"}>Wallet Explorer</option>
            </select>
          </div>
        </div>
          ...
          <div className={styles.input_button_container}>
            ...
            <div className={styles.select_container_alt}>
              ...
              >
                ...
                <option onSelect={() => fetchNFTs()} className={styles.button_black} value={"GNOSIS_MAINNET"}>Gnosis</option>
              </select>
            </div>
